 ...
 * Control - Switch.
 *
 * @package Ovation Blog Themes
 */

if( class_exists( 'WP_Customize_Control' ) ) {
	class Ovation_Blog_Customizer_Customcontrol_Switch extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'ovation-blog-control-switch', trailingslashit( get_template_directory_uri() ) . 'inc/switch/control_switch.js', array( 'jquery' ) );

			wp_enqueue_style( 'ovation-blog-control-switch', trailingslashit( get_template_directory_uri() ) . 'inc/switch/control_switch.css', '', time() );
