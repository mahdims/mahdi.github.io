...
function ovation_blog_custom_styles($custom) {
	...
	wp_add_inline_style( 'ovation-blog-style', $custom );

}

add_action( 'wp_enqueue_scripts', 'ovation_blog_custom_styles' );


//Sanitizes Fonts
function ovation_blog_sanitize_fonts( $input ) {
	$valid = array(
		'' => 'Select',
