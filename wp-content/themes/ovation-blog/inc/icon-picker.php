...
class Ovation_Blog_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'ovation-blog' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $ovation_blog_font_awesome_icon_array = ovation_blog_font_awesome_icon_array();
                    foreach ($ovation_blog_font_awesome_icon_array as $ovation_blog_font_awesome_icon) {
                            $icon_class = $this->value() == $ovation_blog_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($ovation_blog_font_awesome_icon).'"></i>
                            <span class="ovation-blog-social-class">'.esc_attr($ovation_blog_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function ovation_blog_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'ovation-blog-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'ovation_blog_customizer_script' );

if(!function_exists('ovation_blog_font_awesome_icon_array')){
    function ovation_blog_font_awesome_icon_array(){
